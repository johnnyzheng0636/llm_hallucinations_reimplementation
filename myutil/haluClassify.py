...
class haluClassify():
    ...
    def train_and_eval(self):
        ...
        if self.demo:
            ...
            X_softmax = np.expand_dims(hidden_data['logits'][0][hidden_data['start_pos'][0]], axis=0)
            ...
            X_softmax = np.expand_dims(hidden_data['logits'][1][hidden_data['start_pos'][1]], axis=0)
